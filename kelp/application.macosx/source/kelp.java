import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class kelp extends PApplet {float t=0;
...
public void draw()
{
  ...
  for(y=0;y<width;y++)
  {
    x1=offset1+amplitude1*sin(t+7*pow(y,1.25f)/10000);
    x2=offset2+amplitude2*sin(t+3*pow(y,1.4f)/10000);
  ...
  static public void main(String args[]) {     PApplet.main(new String[] { "kelp" });  }}