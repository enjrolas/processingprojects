import processing.core.*; import processing.video.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; import javax.sound.midi.*; import javax.sound.midi.spi.*; import javax.sound.sampled.*; import javax.sound.sampled.spi.*; import java.util.regex.*; import javax.xml.parsers.*; import javax.xml.transform.*; import javax.xml.transform.dom.*; import javax.xml.transform.sax.*; import javax.xml.transform.stream.*; import org.xml.sax.*; import org.xml.sax.ext.*; import org.xml.sax.helpers.*; public class sketch_071021c extends PApplet { 
...
class smartPixel {
  ...
  smartPixel(smartPixel p, int _c, int _x, int _y) {
    parent = p;
    c = _c;
    numPix = 1;
    x = _x;
  ...
  public smartPixel union(smartPixel n) {
...
public void unionClusters(cluster c1, cluster c2) {
  ...
  static public void main(String args[]) {     PApplet.main(new String[] { "sketch_071021c" });  }}